package ru.otus.java.basic.homeworks.hwork18.server;
        ...
        while (true) {
            ...
            if (message.startsWith("/kick ")) {
                ...
                if (this.role == Roles.ADMIN) {
                    String[] element = message.split(" ");
                    if (element.length != 2 || element[1].trim().isEmpty()) {
                        sendMsg("Отсутствуют права для этой команды. Используйте: /add_admin <имя_пользователя>");
                        continue;
                    }
                    ...
                    sendMsg("Отсутствуют права для этой команды.");
                }
